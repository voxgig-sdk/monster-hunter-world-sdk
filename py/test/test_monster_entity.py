    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set MONSTERHUNTERWORLD_TEST_MONSTER_ENTID JSON to run live")
        client = setup["client"]
        ...
        monster_ref01_data_dt0_load_result = helpers.to_map(monster_ref01_data_dt0_loaded)
...
def _monster_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("MONSTERHUNTERWORLD_TEST_MONSTER_ENTID"))

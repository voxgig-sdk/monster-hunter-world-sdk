# MonsterHunterWorld SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MonsterHunterWorldSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MonsterHunterWorldSDK(...) and MonsterHunterWorldSDK.test(...) become
#      MonsterHunterWorldSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "monsterhunterworld_sdk"
_SDK_CLASS = "MonsterHunterWorldSDK"

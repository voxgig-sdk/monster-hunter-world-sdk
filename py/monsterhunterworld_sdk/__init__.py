...
from monsterhunterworld_sdk.utility import register

# Load features
from monsterhunterworld_sdk.feature.base_feature import MonsterHunterWorldBaseFeature
from monsterhunterworld_sdk.features import _make_feature
...
class MonsterHunterWorldSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "MonsterHunterWorldSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MonsterHunterWorldSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ailment(self, data=None) -> "AilmentEntity":
        ...
        from monsterhunterworld_sdk.entity.ailment_entity import AilmentEntity
        return AilmentEntity(self, data)


    def Armor(self, data=None) -> "ArmorEntity":
        """Entity factory: client.Armor().list() / client.Armor().load({"id": ...})."""
        from monsterhunterworld_sdk.entity.armor_entity import ArmorEntity
    ...
    def ArmorSet(self, data=None) -> "ArmorSetEntity":
        ...
        from monsterhunterworld_sdk.entity.armor_set_entity import ArmorSetEntity
        return ArmorSetEntity(self, data)


    def Charm(self, data=None) -> "CharmEntity":
        """Entity factory: client.Charm().list() / client.Charm().load({"id": ...})."""
        from monsterhunterworld_sdk.entity.charm_entity import CharmEntity
    ...
    def Decoration(self, data=None) -> "DecorationEntity":
        ...
        from monsterhunterworld_sdk.entity.decoration_entity import DecorationEntity
    ...
    def Event(self, data=None) -> "EventEntity":
        ...
        from monsterhunterworld_sdk.entity.event_entity import EventEntity
        return EventEntity(self, data)


    def Item(self, data=None) -> "ItemEntity":
        """Entity factory: client.Item().list() / client.Item().load({"id": ...})."""
        from monsterhunterworld_sdk.entity.item_entity import ItemEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from monsterhunterworld_sdk.entity.location_entity import LocationEntity
    ...
    def Monster(self, data=None) -> "MonsterEntity":
        ...
        from monsterhunterworld_sdk.entity.monster_entity import MonsterEntity
    ...
    def MotionValue(self, data=None) -> "MotionValueEntity":
        ...
        from monsterhunterworld_sdk.entity.motion_value_entity import MotionValueEntity
    ...
    def Skill(self, data=None) -> "SkillEntity":
        ...
        from monsterhunterworld_sdk.entity.skill_entity import SkillEntity
    ...
    def Weapon(self, data=None) -> "WeaponEntity":
        ...
        from monsterhunterworld_sdk.entity.weapon_entity import WeaponEntity

...
from monsterhunterworld_sdk.core.control import MonsterHunterWorldControl
...
from monsterhunterworld_sdk.core.helpers import get_ctx_prop, to_map
...
class MonsterHunterWorldContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MonsterHunterWorldControl()
        ...
        if isinstance(sp, MonsterHunterWorldSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MonsterHunterWorldResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MonsterHunterWorldResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MonsterHunterWorldOperation({})
    ...
    def make_error(self, code, msg):
        return MonsterHunterWorldError(code, msg, self)

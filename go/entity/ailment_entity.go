...
func NewAilmentEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *AilmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AilmentEntity) GetName() string { return e.name }
...
func (e *AilmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AilmentEntity) Deleted() bool {
	return e.deleted
}


func (e *AilmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAilmentEntity(e.client, opts)
}

func (e *AilmentEntity) Data(args ...any) any {
...
func (e *AilmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ailment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AilmentEntity) DataTyped(data ...Ailment) Ailment {
	if len(data) > 0 {
		return typedFrom[Ailment](e.Data(asMap(data[0])))
	}
	return typedFrom[Ailment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ailment (all fields
// optional at the wire level).
func (e *AilmentEntity) MatchTyped(match ...Ailment) Ailment {
	if len(match) > 0 {
		return typedFrom[Ailment](e.Match(asMap(match[0])))
	}
	return typedFrom[Ailment](e.Match())
}
...
func (e *AilmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AilmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AilmentLoadMatch and returns an Ailment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AilmentEntity) LoadTyped(reqmatch AilmentLoadMatch, ctrl map[string]any) (Ailment, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ailment{}, err
	}
	return typedFrom[Ailment](res), nil
}




func (e *AilmentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AilmentListMatch and returns []Ailment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AilmentEntity) ListTyped(reqmatch AilmentListMatch, ctrl map[string]any) ([]Ailment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Ailment](res), nil
}



func (e *AilmentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AilmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AilmentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AilmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewMotionValueEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *MotionValueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MotionValueEntity) GetName() string { return e.name }
...
func (e *MotionValueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MotionValueEntity) Deleted() bool {
	return e.deleted
}


func (e *MotionValueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMotionValueEntity(e.client, opts)
}

func (e *MotionValueEntity) Data(args ...any) any {
...
func (e *MotionValueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MotionValue; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MotionValueEntity) DataTyped(data ...MotionValue) MotionValue {
	if len(data) > 0 {
		return typedFrom[MotionValue](e.Data(asMap(data[0])))
	}
	return typedFrom[MotionValue](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MotionValue (all fields
// optional at the wire level).
func (e *MotionValueEntity) MatchTyped(match ...MotionValue) MotionValue {
	if len(match) > 0 {
		return typedFrom[MotionValue](e.Match(asMap(match[0])))
	}
	return typedFrom[MotionValue](e.Match())
}
...
func (e *MotionValueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MotionValueEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MotionValueLoadMatch and returns an MotionValue. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MotionValueEntity) LoadTyped(reqmatch MotionValueLoadMatch, ctrl map[string]any) (MotionValue, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MotionValue{}, err
	}
	return typedFrom[MotionValue](res), nil
}




func (e *MotionValueEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MotionValueListMatch and returns []MotionValue. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MotionValueEntity) ListTyped(reqmatch MotionValueListMatch, ctrl map[string]any) ([]MotionValue, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MotionValue](res), nil
}



func (e *MotionValueEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MotionValueEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MotionValueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MotionValueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewArmorSetEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *ArmorSetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArmorSetEntity) GetName() string { return e.name }
...
func (e *ArmorSetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArmorSetEntity) Deleted() bool {
	return e.deleted
}


func (e *ArmorSetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArmorSetEntity(e.client, opts)
}

func (e *ArmorSetEntity) Data(args ...any) any {
...
func (e *ArmorSetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ArmorSet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArmorSetEntity) DataTyped(data ...ArmorSet) ArmorSet {
	if len(data) > 0 {
		return typedFrom[ArmorSet](e.Data(asMap(data[0])))
	}
	return typedFrom[ArmorSet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ArmorSet (all fields
// optional at the wire level).
func (e *ArmorSetEntity) MatchTyped(match ...ArmorSet) ArmorSet {
	if len(match) > 0 {
		return typedFrom[ArmorSet](e.Match(asMap(match[0])))
	}
	return typedFrom[ArmorSet](e.Match())
}
...
func (e *ArmorSetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArmorSetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArmorSetLoadMatch and returns an ArmorSet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArmorSetEntity) LoadTyped(reqmatch ArmorSetLoadMatch, ctrl map[string]any) (ArmorSet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ArmorSet{}, err
	}
	return typedFrom[ArmorSet](res), nil
}




func (e *ArmorSetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ArmorSetListMatch and returns []ArmorSet. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArmorSetEntity) ListTyped(reqmatch ArmorSetListMatch, ctrl map[string]any) ([]ArmorSet, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ArmorSet](res), nil
}



func (e *ArmorSetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArmorSetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArmorSetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArmorSetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

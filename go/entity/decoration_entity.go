...
func NewDecorationEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *DecorationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DecorationEntity) GetName() string { return e.name }
...
func (e *DecorationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DecorationEntity) Deleted() bool {
	return e.deleted
}


func (e *DecorationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDecorationEntity(e.client, opts)
}

func (e *DecorationEntity) Data(args ...any) any {
...
func (e *DecorationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Decoration; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DecorationEntity) DataTyped(data ...Decoration) Decoration {
	if len(data) > 0 {
		return typedFrom[Decoration](e.Data(asMap(data[0])))
	}
	return typedFrom[Decoration](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Decoration (all fields
// optional at the wire level).
func (e *DecorationEntity) MatchTyped(match ...Decoration) Decoration {
	if len(match) > 0 {
		return typedFrom[Decoration](e.Match(asMap(match[0])))
	}
	return typedFrom[Decoration](e.Match())
}
...
func (e *DecorationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DecorationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DecorationLoadMatch and returns an Decoration. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DecorationEntity) LoadTyped(reqmatch DecorationLoadMatch, ctrl map[string]any) (Decoration, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Decoration{}, err
	}
	return typedFrom[Decoration](res), nil
}




func (e *DecorationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DecorationListMatch and returns []Decoration. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DecorationEntity) ListTyped(reqmatch DecorationListMatch, ctrl map[string]any) ([]Decoration, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Decoration](res), nil
}



func (e *DecorationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DecorationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DecorationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DecorationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

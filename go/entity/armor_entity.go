...
func NewArmorEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *ArmorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArmorEntity) GetName() string { return e.name }
...
func (e *ArmorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArmorEntity) Deleted() bool {
	return e.deleted
}


func (e *ArmorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArmorEntity(e.client, opts)
}

func (e *ArmorEntity) Data(args ...any) any {
...
func (e *ArmorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Armor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArmorEntity) DataTyped(data ...Armor) Armor {
	if len(data) > 0 {
		return typedFrom[Armor](e.Data(asMap(data[0])))
	}
	return typedFrom[Armor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Armor (all fields
// optional at the wire level).
func (e *ArmorEntity) MatchTyped(match ...Armor) Armor {
	if len(match) > 0 {
		return typedFrom[Armor](e.Match(asMap(match[0])))
	}
	return typedFrom[Armor](e.Match())
}
...
func (e *ArmorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArmorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArmorLoadMatch and returns an Armor. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArmorEntity) LoadTyped(reqmatch ArmorLoadMatch, ctrl map[string]any) (Armor, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Armor{}, err
	}
	return typedFrom[Armor](res), nil
}




func (e *ArmorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ArmorListMatch and returns []Armor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArmorEntity) ListTyped(reqmatch ArmorListMatch, ctrl map[string]any) ([]Armor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Armor](res), nil
}



func (e *ArmorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArmorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArmorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArmorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewWeaponEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *WeaponEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WeaponEntity) GetName() string { return e.name }
...
func (e *WeaponEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WeaponEntity) Deleted() bool {
	return e.deleted
}


func (e *WeaponEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWeaponEntity(e.client, opts)
}

func (e *WeaponEntity) Data(args ...any) any {
...
func (e *WeaponEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *WeaponEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WeaponEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *WeaponEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WeaponEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WeaponEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WeaponEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewCharmEntity(client *core.MonsterHunterWorldSDK, entopts map[string]any) *CharmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CharmEntity) GetName() string { return e.name }
...
func (e *CharmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CharmEntity) Deleted() bool {
	return e.deleted
}


func (e *CharmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCharmEntity(e.client, opts)
}

func (e *CharmEntity) Data(args ...any) any {
...
func (e *CharmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Charm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CharmEntity) DataTyped(data ...Charm) Charm {
	if len(data) > 0 {
		return typedFrom[Charm](e.Data(asMap(data[0])))
	}
	return typedFrom[Charm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Charm (all fields
// optional at the wire level).
func (e *CharmEntity) MatchTyped(match ...Charm) Charm {
	if len(match) > 0 {
		return typedFrom[Charm](e.Match(asMap(match[0])))
	}
	return typedFrom[Charm](e.Match())
}
...
func (e *CharmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CharmEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CharmLoadMatch and returns an Charm. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CharmEntity) LoadTyped(reqmatch CharmLoadMatch, ctrl map[string]any) (Charm, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Charm{}, err
	}
	return typedFrom[Charm](res), nil
}




func (e *CharmEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CharmListMatch and returns []Charm. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CharmEntity) ListTyped(reqmatch CharmListMatch, ctrl map[string]any) ([]Charm, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Charm](res), nil
}



func (e *CharmEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CharmEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CharmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CharmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

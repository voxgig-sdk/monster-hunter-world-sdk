...
const testSeed = `map[string]any{"entity": map[string]any{"ailment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "armor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "armor_set": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "charm": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "decoration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "motion_value": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "skill": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "weapon": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

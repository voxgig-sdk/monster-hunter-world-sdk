...
import (
	...
	"github.com/voxgig-sdk/monster-hunter-world-sdk/go/entity"
	"github.com/voxgig-sdk/monster-hunter-world-sdk/go/feature"
	_ "github.com/voxgig-sdk/monster-hunter-world-sdk/go/utility"
)
...
// instead of `sdk.NewMonsterHunterWorldSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MonsterHunterWorldSDK  { return NewMonsterHunterWorldSDK(nil) }
func Test() *MonsterHunterWorldSDK { return TestSDK(nil, nil) }

...
local MotionValueEntity = {}
MotionValueEntity.__index = MotionValueEntity


function MotionValueEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MotionValueEntity)
  self._name = "motion_value"
  self._client = client
...
function MotionValueEntity:get_name()
  return self._name
end


function MotionValueEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MotionValueEntity.new(self._client, opts)
end
...
function MotionValueEntity:mark_deleted()
  self._deleted = true
end


function MotionValueEntity:deleted()
  return true == self._deleted
end


function MotionValueEntity:data_set(args)
  if args ~= nil then
...
function MotionValueEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MotionValueEntity:match_set(args)
  if args ~= nil then
...
function MotionValueEntity:match_get()
...
function MotionValueEntity:stream(action, args, callopts)
...
function MotionValueEntity:_run_op(ctx, post_done)
  local utility = self._utility

...
describe("DecorationDirect", function()
  it("should direct-list-decoration", function()
    local setup = decoration_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-decoration", setup.live and "live" or "unit")
  ...
  it("should direct-load-decoration", function()
    local setup = decoration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-decoration", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function decoration_direct_setup(mockres)

...
describe("AilmentDirect", function()
  it("should direct-list-ailment", function()
    local setup = ailment_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ailment", setup.live and "live" or "unit")
  ...
  it("should direct-load-ailment", function()
    local setup = ailment_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ailment", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function ailment_direct_setup(mockres)

// Command MonsterHunterWorld-mcp is an MCP server exposing the MonsterHunterWorld
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MonsterHunterWorld_list  — list records of an entity
//	MonsterHunterWorld_load  — load a single record of an entity
//

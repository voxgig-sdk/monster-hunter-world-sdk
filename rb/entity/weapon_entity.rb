...
class WeaponEntity
  ...
  #   as an empty match, so client.Weapon.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Weapon, Hash] the loaded Weapon; raises MonsterHunterWorldError on failure
  ...
  #
  # @param reqmatch [WeaponListMatch, Hash, nil] match filter (any subset of
  #   Weapon fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Weapon>, Array] the matching Weapon items; raises MonsterHunterWorldError on failure

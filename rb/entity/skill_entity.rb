# MonsterHunterWorld SDK Skill entity
...
class SkillEntity
  ...
  # @return [Skill, Hash] the loaded Skill; raises MonsterHunterWorldError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Skill>, Array] the matching Skill items; raises MonsterHunterWorldError on failure

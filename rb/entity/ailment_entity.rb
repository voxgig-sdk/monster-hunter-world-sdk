...
class AilmentEntity
  ...
  def make
    opts = @_entopts.dup
    AilmentEntity.new(@_client, opts)
  end
  ...
  # @return [Ailment, Hash] the current Ailment data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Ailment fields)
  def match_get
  ...
  #
  # @param reqmatch [AilmentLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ailment.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ailment, Hash] the loaded Ailment; raises MonsterHunterWorldError on failure
  ...
  #
  # @param reqmatch [AilmentListMatch, Hash, nil] match filter (any subset of
  #   Ailment fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Ailment>, Array] the matching Ailment items; raises MonsterHunterWorldError on failure

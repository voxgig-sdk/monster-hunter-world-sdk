# MonsterHunterWorld SDK Location entity
...
class LocationEntity
  ...
  # @return [Location, Hash] the loaded Location; raises MonsterHunterWorldError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises MonsterHunterWorldError on failure

...
class MotionValueEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MONSTERHUNTERWORLD_TEST_MOTION_VALUE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def motion_value_basic_setup(extra)
  ...
  entid_env_raw = ENV["MONSTERHUNTERWORLD_TEST_MOTION_VALUE_ENTID"]

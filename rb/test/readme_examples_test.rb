...
#      offline in seeded test mode (MonsterHunterWorldSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MonsterHunterWorld_sdk.rb")
  SDK_CLASS = "MonsterHunterWorldSDK"
  ...
  SDK_BASE = "MonsterHunterWorld_sdk"

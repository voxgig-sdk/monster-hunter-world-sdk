...
class SkillEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MONSTER_HUNTER_WORLD_TEST_SKILL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def skill_basic_setup(extra)
  ...
  entid_env_raw = ENV["MONSTER_HUNTER_WORLD_TEST_SKILL_ENTID"]

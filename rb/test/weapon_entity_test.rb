...
class WeaponEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MONSTER_HUNTER_WORLD_TEST_WEAPON_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def weapon_basic_setup(extra)
  ...
  entid_env_raw = ENV["MONSTER_HUNTER_WORLD_TEST_WEAPON_ENTID"]

...
// MonsterHunterWorld SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MonsterHunterWorldMakeRequest
{
    public static function call(MonsterHunterWorldContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MonsterHunterWorldResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MonsterHunterWorldResponse($fetched);
        } else {

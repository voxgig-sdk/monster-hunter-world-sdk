...
// MonsterHunterWorld SDK pipeline test
//
...
{
    private static function utility(): MonsterHunterWorldUtility
    {
        return new MonsterHunterWorldUtility();
    }
    ...
    private static function ctx(array $over = []): MonsterHunterWorldContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MonsterHunterWorldContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MonsterHunterWorldError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MonsterHunterWorldMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MonsterHunterWorldMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MonsterHunterWorldMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MonsterHunterWorldSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MonsterHunterWorldMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MonsterHunterWorldResponse([]),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        [, $err] = MonsterHunterWorldMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec([]),
            'response' => null,
            'result' => new MonsterHunterWorldResult([]),
        ]);
        [, $err] = MonsterHunterWorldMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec(['step' => 's']),
            'response' => new MonsterHunterWorldResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        [, $err] = MonsterHunterWorldMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec(['step' => 's']),
            'response' => new MonsterHunterWorldResponse(self::resp(200, ['v' => 1])),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        [, $err] = MonsterHunterWorldMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec(['step' => 's']),
            'response' => new MonsterHunterWorldResponse(self::resp(200, ['v' => 2])),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MonsterHunterWorldMakeResponse::call($ctx);
    ...
    {
        $preset = new MonsterHunterWorldResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec([]),
            'response' => new MonsterHunterWorldResponse([]),
            'result' => new MonsterHunterWorldResult([]),
        ...
        [$got, $err] = MonsterHunterWorldMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MonsterHunterWorldResult([])]);
        [, $err] = MonsterHunterWorldMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MonsterHunterWorldSpec([]), 'result' => null]);
        [, $err] = MonsterHunterWorldMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MonsterHunterWorldSpec(['step' => 's']),
            'result' => new MonsterHunterWorldResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MonsterHunterWorldMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MonsterHunterWorldSpec(['step' => 's']),
            'result' => new MonsterHunterWorldResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MonsterHunterWorldOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MonsterHunterWorldMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MonsterHunterWorldResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MonsterHunterWorldSpec([]),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MonsterHunterWorldMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MonsterHunterWorldMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MonsterHunterWorldError('boom', 'boom');
        $utility->fetcher = function (MonsterHunterWorldContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MonsterHunterWorldSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MonsterHunterWorldMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MonsterHunterWorldContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MonsterHunterWorldMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MonsterHunterWorldResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MonsterHunterWorldMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MonsterHunterWorldContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MonsterHunterWorldSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MonsterHunterWorldMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MonsterHunterWorldResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MonsterHunterWorldSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MonsterHunterWorldMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MonsterHunterWorldMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MonsterHunterWorldMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MonsterHunterWorldResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MonsterHunterWorldDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MonsterHunterWorldResult(['ok' => false])]);
        $this->expectException(MonsterHunterWorldError::class);
        MonsterHunterWorldDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MonsterHunterWorldResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MonsterHunterWorldMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MonsterHunterWorldMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MonsterHunterWorldBaseFeature();
        $b = new MonsterHunterWorldBaseFeature();
        MonsterHunterWorldFeatureAdd::call($ctx, $a);
        MonsterHunterWorldFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MonsterHunterWorldBaseFeature
    {
        $f = new MonsterHunterWorldBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MonsterHunterWorldFeatureAdd::call($ctx, self::named_feature('a'));
        MonsterHunterWorldFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MonsterHunterWorldFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MonsterHunterWorldFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MonsterHunterWorldFeatureAdd::call($ctx, $replace);
        ...
        MonsterHunterWorldFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MonsterHunterWorldContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MonsterHunterWorldSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MonsterHunterWorldPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MonsterHunterWorldPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MonsterHunterWorldResponse(['headers' => null]),
            'result' => new MonsterHunterWorldResult([]),
        ]);
        MonsterHunterWorldResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MonsterHunterWorldResultBody::call($ctx);

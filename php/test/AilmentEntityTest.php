...
class AilmentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MONSTERHUNTERWORLD_TEST_AILMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ailment_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MONSTERHUNTERWORLD_TEST_AILMENT_ENTID");

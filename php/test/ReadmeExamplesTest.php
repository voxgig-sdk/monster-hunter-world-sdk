...
// MonsterHunterWorld SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MonsterHunterWorldSDK::test)
...
{
    private const SDK_CLASS = 'MonsterHunterWorldSDK';
    ...
    private const SDK_BASE = 'monsterhunterworld_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../monsterhunterworld_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

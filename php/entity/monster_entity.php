...
class MonsterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MonsterEntity($this->_client, $opts);
    }

    /**
     * @param Monster|array $args Monster data (assoc-array) to store.
     */
    ...
    /**
     * @return Monster|array The current Monster data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Monster fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Monster fields).
     */
     ...
     *
     * @param MonsterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MonsterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Monster|array The loaded Monster as an assoc-array at the
    ...
    /**
     * List Monster items matching the given filter.
     *
     * @param MonsterListMatch|array|null $reqmatch Match filter (any subset
     *   of Monster fields) as an assoc-array; MonsterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Monster[]|array A list of Monster items as assoc-arrays at

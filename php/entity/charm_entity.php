...
// MonsterHunterWorld SDK Charm entity
...
class CharmEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CharmEntity($this->_client, $opts);
    }

    /**
     * @param Charm|array $args Charm data (assoc-array) to store.
     */
    ...
    /**
     * @return Charm|array The current Charm data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Charm fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Charm fields).
     */
     ...
     * Load a single Charm.
     *
     * @param CharmLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CharmLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Charm|array The loaded Charm as an assoc-array at the
     ...
     *
     * @param CharmListMatch|array|null $reqmatch Match filter (any subset
     *   of Charm fields) as an assoc-array; CharmListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Charm[]|array A list of Charm items as assoc-arrays at

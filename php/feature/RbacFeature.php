...
// MonsterHunterWorld SDK rbac feature
...
class MonsterHunterWorldRbacFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _required(MonsterHunterWorldContext $ctx): ?string
    {
    ...
    private function _reject(MonsterHunterWorldContext $ctx, string $required): void
    {
    ...
    private function _track(MonsterHunterWorldContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

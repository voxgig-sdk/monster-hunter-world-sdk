...
// MonsterHunterWorld SDK cache feature
...
class MonsterHunterWorldCacheFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _through(MonsterHunterWorldContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

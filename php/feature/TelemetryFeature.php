...
// MonsterHunterWorld SDK telemetry feature
...
class MonsterHunterWorldTelemetryFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _close(MonsterHunterWorldContext $ctx, bool $ok): void
    {

...
// MonsterHunterWorld SDK audit feature
...
class MonsterHunterWorldAuditFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _emit(MonsterHunterWorldContext $ctx, string $outcome): void
    {

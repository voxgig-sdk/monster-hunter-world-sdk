...
// MonsterHunterWorld SDK netsim feature
...
class MonsterHunterWorldNetsimFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _simulate(MonsterHunterWorldContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MonsterHunterWorldContext $ctx, array $applied): void
    {
        $client = $this->client;

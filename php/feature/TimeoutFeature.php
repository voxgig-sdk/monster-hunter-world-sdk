...
// MonsterHunterWorld SDK timeout feature
...
class MonsterHunterWorldTimeoutFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _with_timeout(MonsterHunterWorldContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MonsterHunterWorldContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// MonsterHunterWorld SDK ratelimit feature
...
class MonsterHunterWorldRatelimitFeature extends MonsterHunterWorldBaseFeature
{
    ...
    private function _acquire(MonsterHunterWorldContext $ctx): void
    {
    ...
    private function _track(MonsterHunterWorldContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

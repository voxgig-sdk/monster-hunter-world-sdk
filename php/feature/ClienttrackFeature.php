...
// MonsterHunterWorld SDK clienttrack feature
...
class MonsterHunterWorldClienttrackFeature extends MonsterHunterWorldBaseFeature
{
    ...
    public function PostConstruct(MonsterHunterWorldContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MonsterHunterWorld-SDK';

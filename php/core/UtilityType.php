...
// MonsterHunterWorld SDK utility type

class MonsterHunterWorldUtility
{
    ...
    public static function copy(MonsterHunterWorldUtility $src): MonsterHunterWorldUtility
    {
        $u = new MonsterHunterWorldUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

...
//     (\`new MonsterHunterWorldSDK(...)\` / \`MonsterHunterWorldSDK.test(...)\` become
//     \`MonsterHunterWorldSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'MonsterHunterWorldSDK'
...
const TEST_SEED = {"entity":{"ailment":{"test01":{"id":"test01"}},"armor":{"test01":{"id":"test01"}},"armor_set":{"test01":{"id":"test01"}},"charm":{"test01":{"id":"test01"}},"decoration":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"item":{"test01":{"id":"test01"}},"location":{"test01":{"id":"test01"}},"monster":{"test01":{"id":"test01"}},"motion_value":{"test01":{"id":"test01"}},"skill":{"test01":{"id":"test01"}},"weapon":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new MonsterHunterWorldSDK(...)\` and any
// \`MonsterHunterWorldSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+MonsterHunterWorldSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/MonsterHunterWorldSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)

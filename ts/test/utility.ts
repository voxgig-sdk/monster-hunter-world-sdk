...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MONSTERHUNTERWORLD_TEST_LIVE ||
    'TRUE' === process.env.MONSTERHUNTERWORLD_TEST_OVERRIDE
  ) {
  ...
  m.MONSTERHUNTERWORLD_TEST_EXPLAIN = process.env.MONSTERHUNTERWORLD_TEST_EXPLAIN || m.MONSTERHUNTERWORLD_TEST_EXPLAIN

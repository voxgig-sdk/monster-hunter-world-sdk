...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MONSTER_HUNTER_WORLD_TEST_LIVE ||
    'TRUE' === process.env.MONSTER_HUNTER_WORLD_TEST_OVERRIDE
  ) {
  ...
  m.MONSTER_HUNTER_WORLD_TEST_EXPLAIN = process.env.MONSTER_HUNTER_WORLD_TEST_EXPLAIN || m.MONSTER_HUNTER_WORLD_TEST_EXPLAIN

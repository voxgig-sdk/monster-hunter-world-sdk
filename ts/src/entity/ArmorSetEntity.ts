...
class ArmorSetEntity extends MonsterHunterWorldEntityBase<ArmorSet> {
  ...
  constructor(client: MonsterHunterWorldSDK, entopts: any) {
    ...
    this.name = 'armor_set'
    this.name_ = 'armor_set'
    this.Name = 'ArmorSet'
  }


  make(this: ArmorSetEntity) {
    return new ArmorSetEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ArmorSetLoadMatch, ctrl?: Control): Promise<ArmorSetEntity> {
  ...
  async list(this: any, reqmatch?: ArmorSetListMatch, ctrl?: Control): Promise<ArmorSetEntity[]> {

...
class AilmentEntity extends MonsterHunterWorldEntityBase<Ailment> {
  ...
  make(this: AilmentEntity) {
    return new AilmentEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AilmentLoadMatch, ctrl?: Control): Promise<AilmentEntity> {
  ...
  async list(this: any, reqmatch?: AilmentListMatch, ctrl?: Control): Promise<AilmentEntity[]> {

...
class DecorationEntity extends MonsterHunterWorldEntityBase<Decoration> {
  ...
  constructor(client: MonsterHunterWorldSDK, entopts: any) {
    ...
    this.name_ = 'decoration'
    this.Name = 'Decoration'
  }


  make(this: DecorationEntity) {
    return new DecorationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: DecorationLoadMatch, ctrl?: Control): Promise<DecorationEntity> {
  ...
  async list(this: any, reqmatch?: DecorationListMatch, ctrl?: Control): Promise<DecorationEntity[]> {

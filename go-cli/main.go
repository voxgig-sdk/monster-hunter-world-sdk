// Command MonsterHunterWorld-cli is a CLI + REPL for the MonsterHunterWorld SDK,
...
const prompt = "monster-hunter-world"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "ailment armor armor_set charm decoration event item location monster motion_value skill weapon"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MONSTER_HUNTER_WORLD_APIKEY (api key), MONSTER_HUNTER_WORLD_BASE (base url override)")

...
func registerSDKWords(r *eng.Registry, client *sdk.MonsterHunterWorldSDK) {
...
func runOp(client *sdk.MonsterHunterWorldSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

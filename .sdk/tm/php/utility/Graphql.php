...
// MonsterHunterWorld SDK utility: graphql
//
...
class MonsterHunterWorldGraphql
{
    ...
    // equivalent.
    public static function body(MonsterHunterWorldContext $ctx): mixed
    {
    ...
    public static function errors(MonsterHunterWorldContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

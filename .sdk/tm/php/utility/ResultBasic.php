...
// MonsterHunterWorld SDK utility: result_basic

class MonsterHunterWorldResultBasic
{
    public static function call(MonsterHunterWorldContext $ctx): ?MonsterHunterWorldResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MonsterHunterWorldError) ? $result->err->msg : (string)$result->err;

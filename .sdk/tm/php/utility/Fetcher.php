...
// MonsterHunterWorld SDK utility: fetcher

class MonsterHunterWorldFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MonsterHunterWorldSDK/1.0)';
    ...
    public static function call(MonsterHunterWorldContext $ctx, string $fullurl, array $fetchdef): array
    {

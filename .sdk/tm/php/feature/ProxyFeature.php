...
// MonsterHunterWorld SDK proxy feature
...
class MonsterHunterWorldProxyFeature extends MonsterHunterWorldBaseFeature
{
    ...
    public function init(MonsterHunterWorldContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MonsterHunterWorldContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

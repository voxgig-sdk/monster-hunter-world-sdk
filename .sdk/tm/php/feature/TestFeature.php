...
// MonsterHunterWorld SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MonsterHunterWorldTestFeature extends MonsterHunterWorldBaseFeature
{
    ...
    public function init(MonsterHunterWorldContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MonsterHunterWorldContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MonsterHunterWorldParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MonsterHunterWorldContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MonsterHunterWorldContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MonsterHunterWorldParam::call($ctx, $k);
